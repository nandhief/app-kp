        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('kode', old('kode'), ['class' => 'form-control', 'placeholder' => 'Kosongkan untuk generate kode otomatis']) !!}
                ...
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('name', old('name'), ['class' => 'form-control', 'placeholder' => 'Nama produk']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('name'))
                        <p class="help-block">
                            {{ $errors->first('name') }}
                ...
                <div class="col-xs-12 form-group">
                    ...
                    <select name="category" id="category" class="form-control">
                        ...
                        @foreach($categories as $category)
                            <option value="{{ $category->id }}">{{ $category->kode . "\t - " . $category->name }}</option>
                        @endforeach
                    </select>
                    <p class="help-block"></p>
